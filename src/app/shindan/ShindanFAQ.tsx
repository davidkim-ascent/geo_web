...
const SHINDAN_FAQS = [
  { q: "対応しているAIモデルは？", a: "Chat GPT、Gemini、Google AI モード、AI Overviews、Perplexity、Copilot、6つに対応しています。" },
  ...
  { q: "無料トライアル期間はありますか？", a: "GEO Watcher、GEO診断レポート各ページで、ソリューションの詳細機能をご確認いただけます。無料トライアル(デモ)が必要な場合は、別途お問い合わせフォームからご連絡ください。対応させていただきます。" },
...
export function ShindanFAQ() {
  ...
  return (
    <section id="faq" className="bg-white pt-[80px] pb-[120px]">
