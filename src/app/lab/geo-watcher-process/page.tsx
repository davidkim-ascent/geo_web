          ...
          <div className="article-shell__grid lg:grid-cols-[220px_1fr]">
            ...
            <article className="article-body">
              ...
              <section id="s9" className="article-section">
                ...
                <p className="article-prose">
                  ひとつのトピックの下で、消費者は必ず質問を続けます。この質問の連なりのどこに自社が回答者として登場できるかが、プロンプト設計の重要ポイントです。プロンプトは担当者が考えて作るのも問題ありませんが、それだとバイアスがかかります。SEOであれば検索ボリュームという定量的な判断ができましたが、GEO・<Link href="/lab/what-is-llmo" className="text-[#1452FF] underline decoration-[#1452FF]/30 underline-offset-4">LLMO</Link>では定量的に判断できる材料がありません。
                </p>
                <p className="article-prose">
