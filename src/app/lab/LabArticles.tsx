...
const POSTS = [
  ...
  { cat: "SELF CHECK", date: "2026.08.28", read: "6 min", t: "自社サイトはAIにどれだけ引用されている？セルフチェック方法", d: "ChatGPT・Gemini・Perplexity・Copilotなどの主要AIモデルに自社サイトはどれだけ引用されるかのセルフチェック方法を分かりやすく解説します。", href: "/lab/ai-citation-self-check", thumbVariant: "self-check" as const },
  { cat: "GEO / LLMO TOOLS", date: "2026.08.26", read: "10 min", t: "GEO・LLMO対策ツール15選！料金や機能などを徹底比較", d: "GEO・LLMO対策ツール15個を料金プラン・対応AIモデル数・機能などの観点から徹底比較。失敗しない選び方から具体的な対策プロセスまで解説。", href: "/lab/geo-llmo-tools", thumbVariant: "geo-llmo-tools" as const },
