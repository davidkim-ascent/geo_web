...
const POSTS = [
  { cat: "SEO vs GEO", date: "2026.05.13", read: "8 min", t: "SEOとGEOは何が違うのか？検索最適化と生成AI最適化を比較", d: "SEOは検索エンジンの上位表示を狙う施策、GEOは生成AIに引用されるための施策。違いと実践方法を比較表でわかりやすく整理する。", href: "/lab/seo-geo" },
  { cat: "ブランド戦略", date: "2026.05.18", read: "10 min", t: "AI検索時代のブランド戦略：キーワードではなく、CEPを制覇せよ", d: "消費者がAIに状況を話しかける時代、ブランド競争の本質はキーワード順位からCEP（カテゴリーエントリーポイント）の占有へ移行している。GEO戦略の核心を解説する。", href: "/lab/brand-cep" },
  { cat: "SEO vs GEO", date: "2026.04.05", read: "6 min", t: "SEO と GEO は、何が決定的に違うのか", d: "「キーワード」と「質問」、「ランク」と「引用」。両者を貫く違いを、検索エンジンの内部構造から整理し、移行戦略を提示する。", href: null },
];
