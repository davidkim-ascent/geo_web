...
export const LAB_ARTICLES: LabArticle[] = [
  ...
  { cat: "GEO / LLMO TOOLS", date: "2026.08.26", read: "10 min", t: "GEO・LLMO対策ツール16選！料金や機能などを徹底比較", d: "GEO・LLMO対策ツール16個を料金プラン・対応AIモデル数・機能などの観点から徹底比較。失敗しない選び方から具体的な対策プロセスまで解説。", href: "/lab/geo-llmo-tools", thumbVariant: "geo-llmo-tools" },
