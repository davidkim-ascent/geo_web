...
## 2026-05-12 20:50
- 차단 이메일 도메인 즉시 검증 추가: `email` 입력 중에도 필드 아래 빨간 에러가 바로 뜨도록 반영함

## 2026-05-12 20:45
- 차단 이메일 도메인 검증 강화: `sex.com` 같은 금지 도메인이 서버 설정보다 먼저 차단되도록 수정함

## 2026-05-12 20:43
- `Webサイト情報` 검증 강화: URL 아닌 임의 문자열이 통과하던 문제를 공통 헬퍼로 수정함

## 2026-05-12 20:41
- 사용자용 문의 메일 템플릿 수정: 안내 시간을 48시간으로 변경하고, 입력한 폼 항목 전체를 본문에 노출하도록 정리함
